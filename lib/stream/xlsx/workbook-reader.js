        ...
        default:
          if (entry.path.match(/xl\/worksheets\/sheet\d+[.]xml/)) {
            ...
            if (this.sharedStrings && this.workbookRels) {
              ...
              // Buffer entry and write to temp file synchronously to avoid
              // async delays that cause unzipper to close the zip stream.
